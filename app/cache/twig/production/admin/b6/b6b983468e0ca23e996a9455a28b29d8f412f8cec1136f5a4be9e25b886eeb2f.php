...
/* __string_template__983076b0b38492d53c4a6655f9d99b956e6b7b20e1b3e1a6c0a4e9ea8fd323c8 */
class __TwigTemplate_aed5f0b1424b50ef4b389fb39361b47505a5917808dfec67ee2d8a32431ce045 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 22
        $this->parent = $this->loadTemplate("default_frame.twig", "__string_template__983076b0b38492d53c4a6655f9d99b956e6b7b20e1b3e1a6c0a4e9ea8fd323c8", 22);
        $this->blocks = array(
    ...
    public function block_main($context, array $blocks = array())
    {
        ...
        // line 33
        echo $this->env->getExtension('Eccube\Twig\Extension\EccubeExtension')->getUrl("admin_store_template");
        echo "\">
        ";
        // line 34
        ...
        ";
        // line 35
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? null), "selected", array()), 'widget');
        echo "
        <div class=\"col-md-9\">
            <div class=\"box\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["Template"]) {
            ...
            echo "\" ";
            if (($this->getAttribute($this->getAttribute(($context["app"] ?? null), "config", array()), "template_code", array()) == $this->getAttribute($context["Template"], "code", array()))) {
                                    ...
                                    <td class=\"icon_edit\">
                                        <div class=\"dropdown\">
                                            ...
                                            <ul class=\"dropdown-menu dropdown-menu-right\">
                                                <li><a href=\"";
            // line 70
            echo twig_escape_filter($this->env, $this->env->getExtension('Eccube\Twig\Extension\EccubeExtension')->getUrl("admin_store_template_download", array("id" => $this->getAttribute($context["Template"], "id", array()))), "html", null, true);
            echo "\" >ダウンロード</a></li>
                                                ";
            // line 71
            if ($this->getAttribute($context["Template"], "default_template", array())) {
                ...
                // line 76
                echo "                                                        <li><a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('Eccube\Twig\Extension\EccubeExtension')->getUrl("admin_store_template_delete", array("id" => $this->getAttribute($context["Template"], "id", array()))), "html", null, true);
                echo "\" ";
...
";
    ...
    {
        return "__string_template__983076b0b38492d53c4a6655f9d99b956e6b7b20e1b3e1a6c0a4e9ea8fd323c8";
    }
    ...
    {
        return new Twig_Source("", "__string_template__983076b0b38492d53c4a6655f9d99b956e6b7b20e1b3e1a6c0a4e9ea8fd323c8", "");
    }
}
